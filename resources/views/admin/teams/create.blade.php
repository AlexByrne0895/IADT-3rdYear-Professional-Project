...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">Add new Teams
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select name="league_id">
                                            ...
                                            <option value="{{ $league->id }}" {{ (old('league_id') == $league->id) ? 'selected' : '' }}>{{ $league->name }}</option>
                                            @endforeach
                                        </select>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select name="manager_id">
                                            ...
                                            <option value="{{ $manager->id }}" {{ (old('manager_id') == $manager->id) ? 'selected' : '' }}>{{ $manager->user->name }}</option>
                                            @endforeach
                                        </select>
                                    </td>

...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">Update Matches Form
                    ...
                    <form method="POST" action="{{ route('admin.matches.update', $match->id) }}">
                        ...
                        <table>
                            <tbody>
                              <tr>
                                  <th>Date</th>
                                  <td><input type="text" name="date" value="{{ old('date', $match->date) }}" /></td>
                                  <td>{{ ($errors->has('date')) ? $errors->first('date') : "" }}</td>
                              </tr>

                              <tr>
                                  <th>Time</th>
                                  <td><input type="text" name="time" value="{{ old('time', $match->time) }}" /></td>
